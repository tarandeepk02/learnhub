...
$qryin = mysqli_query($d,"INSERT INTO courses(Title, Picture, Deadline, User_ID) VALUES ('".$_POST['Title']."','".$Picture."','".$_POST['Deadline']."','".$_SESSION['sid']."') ");
        ...
        <div class="card my-4">
          ...
          <div class="card-body px-0 pb-2">
            <div class="card card-plain">
              <div class="card-body">
                <form role="form" action="add_course.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class=" col-md-6">
